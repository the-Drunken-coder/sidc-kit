...
const targetPath = path.join(repoRoot, "src", "data", "catalog", "land-units.ts");
...
export const landUnitSymbols = ${renderSymbols(symbols)} as const satisfies readonly CuratedSymbol[];
`;
}
